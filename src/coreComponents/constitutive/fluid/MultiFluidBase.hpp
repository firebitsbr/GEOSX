...
public:
  ...
  arrayView3d< real64 const > phaseMassDensity() const { return m_phaseDensity; }
  arrayView3d< real64 const > dPhaseMassDensity_dPressure() const { return m_dPhaseDensity_dPressure; }
  arrayView3d< real64 const > dPhaseMassDensity_dTemperature() const { return m_dPhaseDensity_dTemperature; }
  arrayView4d< real64 const > dPhaseMassDensity_dGlobalCompFraction() const { return m_dPhaseDensity_dGlobalCompFraction; }
